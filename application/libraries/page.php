...
class page {
     ...
     */
    public function doconstruct($totalRows,$listRows='',$parameter='',$url='',$mth='') {
    	$this->mth=$mth;
...
//            $url            =   U('',$parameter);
        ...
        $pageStr     =   str_replace(
            ...
            // echo $this->nowPage,$this->totalPages; exit;
            return "<ul>".$pageStr."</ul>";
    }
    public function pageInfo(){
       return "共有 ". $this->totalRows."条数据，当前是第".$this->nowPage."/".$this->totalPages."页";
    }
    public function get_page_info() {
        return $this->_page_info;
    }
    public function urlf($par=array()){
    	$url='';
