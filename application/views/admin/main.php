...
<script>
        ...
        bootbox.confirm("确定要删除选择的首页轮播图片吗？<br> <font color='red'>" +
            ...
            if(result){
                $.ajax({
                    type:"post",
                    data: "id=" + id,
                    url:"<?php echo site_url('a/main/single_remove_image')?>",
        ...
        bootbox.confirm("确定要删除选择的首页轮播图片吗？<br> <font color='red'>" +
            ...
            if(result){
                $.ajax({
                    type:"post",
                    data: "id=" + str,
                    url:"<?php echo site_url('a/main/multi_remove_image')?>",
                    success: function(data){
                        if (data) {
                            window.location.reload();
                        }
    ...
    function save() {
        ...
        $.ajax({
            type:"post",
            data: formData,
            url:"<?php echo site_url('a/main/edit_image')?>",
            success: function(data){
                if (data) {
                    window.location.reload();
                }
            ...
            <div id="pad-wrapper">
                <div class="table-products section">
                    <div class="row-fluid head">
                        <div class="span12">
                            <h4>首页 <small>背景轮播图片列表</small></h4>
                        </div>
                    </div>
                    <div class="row-fluid filter-block">
                        <div class="pull-right">
                            <a class="btn-flat new-product" onclick="upload_multi('<?php echo base_url() ?>','a/main/upload_image')"><i class="icon-upload-alt"></i>添加图片</a>
