...
<script>
    ...
    function single_remove(id) {
        bootbox.confirm("确定要删除选择的图片吗？<br> <font color='red'>" +
            "注意：删除图片操作不可恢复，请谨慎操作。</font> ", function (result) {
            if (result) {
                $.ajax({
                    type: "post",
                    data: "id=" + id,
                    url: "<?php echo site_url('a/store/single_remove_image')?>",
        ...
        bootbox.confirm("确定要删除选择的图片吗？<br> <font color='red'>" +
            ...
            if (result) {
                $.ajax({
                    type: "post",
                    data: "id=" + str,
                    url: "<?php echo site_url('a/store/multi_remove_image')?>",
                    success: function (data) {
                        if (data) {
                            window.location.reload();
                        }
    ...
    function save() {
        ...
        $.ajax({
            type: "post",
            data: formData,
            url: "<?php echo site_url('a/store/edit_image')?>",
            success: function (data) {
                if (data) {
                    window.location.reload();
                }
